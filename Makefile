all:	train test test_quantized predict quantize prune summary libnn.a libnn.so
...
clean:
	$(RM) data_prep.o nn.o libnn.a libnn.so train test test_quantized predict quantize prune summary model*.txt tags
